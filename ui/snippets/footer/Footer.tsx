    ...
    (gridArea?: GridProps['gridArea']) => {
      return (
        <Box gridArea={ gridArea }>
          <Link fontSize="xs" href="https://web3games.com">
            web3games.com
          </Link>
          <Text mt={ 3 } fontSize="xs">
            Web3Games.com is a decentralized crypto gaming ecosystem and
            blockchain network with the objective of accelerating the
            world&apos;s transition to on-chain gaming.
          </Text>
